...
public class FifthGmain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifth_gmain);
        ...
        policy.createPolicyDialog("https://www.iubenda.com/privacy-policy/43922247", "I Agree", Color.RED, "Dont Agree", Color.GREEN);
    }
    ...
    private void LaunchGameContent() {
        new Handler(Looper.getMainLooper()).postDelayed(() -> {
            ...
            gameView.createGameUI(mgdUtil.gameURL, true, "ca-app-pub-9426884596605370/4498359653");
        }, 300);
