...
public class FifthLoad extends AppCompatActivity {
    mgdUtil tools;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifth_load);



        tools = FifthGlobalCFG.getTools(this);
        ...
        splashUI.createSplashUI(FifthLoad.this, FifthGmain.class, R.raw.load);
    }
}